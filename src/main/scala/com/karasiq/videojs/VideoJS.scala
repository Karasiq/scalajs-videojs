...
// TODO: docs.videojs.com/docs/api/player.html component api, http://docs.videojs.com/docs/api/video.html
@js.native
@JSName("videojs")
...
trait VideoJSPlayer extends js.Object {
  /**
    ...
    */
  def addRemoteTextTrack(options: js.Object): Unit = js.native
  ...
  /**
    ...
    */
  def aspectRatio(ratio: String = ???): String = js.native

  /**
    * Get or set the autoplay attribute.
    * @param value Boolean to determine if video should autoplay
    */
  def autoplay(value: Boolean = ???): Boolean = js.native
  ...
  /**
    ...
    * @return Height when getting
    */
  def height(value: Int = ???): Int = js.native
  ...
  /**
    ...
    * @return Width when getting
    */
  def width(value: Int = ???): Int = js.native
}