...
object Component extends js.Object {
  ...
  /** Constructor
    ...
    */
  def apply(player: Player, options: js.Object = ???, ready: js.Function = ???): Component =
    js.native

  def getComponent(name: String): js.Object =
    js.native

  def registerComponent(name: String, comp: js.Object): Unit =
    js.native
}
...
trait Component extends js.Object {
  ...
  def createEl(tagName: String = ???, properties: js.Object = ???, attributes: js.Object = ???): Element =
    js.native
  ...
  def off(component: Component, event: String, handler: js.Function): this.type =
    js.native

  def off(event: String, handler: js.Function): this.type =
    js.native

  def on(component: Component, event: String, handler: js.Function): this.type =
    js.native

  def on(event: String, handler: js.Function): this.type =
    js.native

  def one(component: Component, event: String, handler: js.Function): this.type =
    js.native

  def one(event: String, handler: js.Function): this.type =
    js.native

  def options(obj: js.Object): js.Object =
    js.native

  def player(): Player =
    js.native

  def ready(fn: js.Function, sync: Boolean): this.type =
    js.native
  ...
  def setInterval(fn: js.Function, interval: Int): Unit =
    js.native

  def setTimeout(fn: js.Function, timeout: Int): Unit =
    js.native

  def show(): Unit =
    js.native

  def toggleClass(classToToggle: String, predicate: js.Function | Boolean = ???): Unit =
    js.native

  def trigger(event: js.Object | String, hash: js.Object = ???): Unit =
    js.native
